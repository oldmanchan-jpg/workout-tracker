...
export default function BottomNav() {
  ...
  return (
    ...
    >
      {/* Glass pill wrapper */}
      <div className="rounded-[28px] bg-[rgba(11,13,16,0.95)] backdrop-blur-2xl border border-white/[0.08] shadow-[0_8px_32px_rgba(0,0,0,0.6),0_0_0_1px_rgba(255,255,255,0.03)_inset] px-3 py-3">
